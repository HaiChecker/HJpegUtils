...
"jpeglib.h"
#include
"jchuff.h"        /* Declarations shared with jcphuff.c */
#include
<limits.h>
...
NO_STRUCT_ASSIGN
#define
ASSIGN_STATE(dest, src)  ((dest) = (src))
#else
#if
MAX_COMPS_IN_SCAN == 4
#define
ASSIGN_STATE(dest, src)  \
...
#ifdef
ENTROPY_OPT_SUPPORTED    /* Statistics tables for optimization */
